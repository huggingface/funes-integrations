#!/bin/sh
# hermes's automation: advance funes's index over this agent's spool and, at a session boundary,
# publish it. The plugin converts each turn itself and spawns this script detached, so the work is
